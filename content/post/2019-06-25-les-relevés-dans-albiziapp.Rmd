...
Une fois authentifié on peut accéder à la carte (\@ref(fig:Carte)). Notre localisation est représentée par une épingle bleue. Il suffit d'appuyer un peu sur l’écran pour voir apparaître le menu de création de relevé (\@ref(fig:Confirm)). On peut ensuite abandonner ("Cancel") ou continuer la procédure ("OK").
...
Il est ensuite possible d'indiquer le nom de l'espèce (en latin), son genre et son nom vernaculaire (en français). Si vous avec un doute signalez le avec le menu "Confiance". Vous pouvez ensuite prendre une photo pour l'ajouter. Enfin il est possible d'enregistrer se relevé ou encore de l'annuler.
...
Votre relevé apparaît comme un rond de contour rouge. Il est possible de le modifier ou encore de la supprimer (\@ref(fig:modifsup)) (du moins tant que personne d'autre que vous ne l'a changé) 
